...
$username = $_SESSION['username']; // Leer el valor de la cookie de sesión
 ...
 //MUESTRO LOS CAMPOS PARA EDITAR LA PUBLICACION Y VALIDA LA PUBLICACION REALIZADA POR EL USUARIO
 function editarPublicacion($username_pub, $user, $id_pub, $titulo_pub, $contenido_pub){
 ...
 //MUESTRA LOS CAMPOS NECESARIOS PARA EDITAR LA PUBLICACION
