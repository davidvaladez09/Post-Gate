            ...
            if (isset($_SESSION['username']) && $_SESSION['username'] == TRUE) {
                ...
                if ($resultado->num_rows > 0) {
                  while ($fila = $resultado->fetch_assoc()) {
                    ...
                    echo "<a id='myLink' href='../views_materias/publicacion.php?nrc=" . urlencode($nrc_materia_compartida) . "&carrera=" . urlencode($carrera) . "' class='btn btn-dark'>Ver foro</a>";
              ...
              while ($fila = $resultado->fetch_assoc()) {
                  ...
                  switch ($semestre_prueba) {
                      case '1':
                          ...
                          echo "<a id='myLink' href='../views_materias/publicacion.php?nrc=" . urlencode($nrc_prueba) . "&carrera=" . urlencode($carrera) . "' class='btn btn-dark'>Ver foro</a>";
                          echo "</div>";
                          echo "</div>";
                          echo "</div>";
                          break;
